...
<img src="https://img.shields.io/badge/Version-1.4.6-blue?style=flat-square" />
...
| Feature | Description |
|---------|-------------|
| **Virtual Button Panel** | D-pad and A/B buttons appear when payloads call `WAIT_FOR_INPUT` or `WAIT_FOR_BUTTON_PRESS` |
| **Smart Button Filtering** | Only allowed buttons are clickable - others are dimmed and disabled |
| **Multi-Button Support** | Supports `WAIT_FOR_BUTTON_PRESS UP DOWN LEFT RIGHT` for multiple allowed buttons |
